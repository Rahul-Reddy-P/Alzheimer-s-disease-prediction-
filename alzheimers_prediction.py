...
font1 = ('times', 14, 'bold')
upload_btn = Button(main, text="Upload Image", command=upload)
upload_btn.place(x=700, y=100)
upload_btn.config(font=font1)

process_btn = Button(main, text="Image Pre-Processing", command=imagepreprocess)
process_btn.place(x=700, y=150)
process_btn.config(font=font1)

ld_btn = Button(main, text="Model Load", command=load)
ld_btn.place(x=700, y=200)
ld_btn.config(font=font1)

pred_btn = Button(main, text="Predict", command=predict)
pred_btn.place(x=700, y=250)
pred_btn.config(font=font1)
